...
class WaterViewController: UIViewController,UITextFieldDelegate , UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    let selectYourProvider:UITextField = {
        let syn = UITextField()
        syn.placeholder = "Customer Account Number"
