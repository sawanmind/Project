...
class LandlineViewController: UIViewController ,UIPickerViewDataSource,UIPickerViewDelegate,UITextFieldDelegate{
    ...
    let ID:UITextField = {
        let mn = UITextField()
        mn.placeholder = "Number with ISD/STD Code"
    ...
    var selectYourProvider:UITextField = {
        let syn = UITextField()
