...
//        
        ...
        navigationBarAppearace.barTintColor = UIColor(red: 52/255, green: 70/255, blue: 93/255, alpha: 1)
        let tabbarApperance = UITabBar.appearance()
        tabbarApperance.tintColor = UIColor(red: 52/255, green: 70/255, blue: 93/255, alpha: 1)
